...
<!--================ End Header Area =================-->
    ...
    <center>  <h1>Send us your query anytime!</h1> </center>
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <div class="contact_info">
                        <div class="info_item">
                            ...
                            <h6>Marilao,Bulacan Philippines</h6>
                            <p>Sta.Rosa 2</p>
                        </div>
                        <div class="info_item">
                            <i class="lnr lnr-phone-handset"></i>
                            <h6><a href="#">(+63)-945-445-4744</a></h6>
                            <p>Mon to Saturday 9am to 6 pm</p>
                        </div>
                        <div class="info_item">
                            <i class="lnr lnr-envelope"></i>
                            <h6><a href="mailto:padillajoshuaanderson.pdm@gmail.com">padillajoshuaanderson.pdm@gmail.com</a></h6>
					 ...
					 <form class="row contact_form" action="contact.php" method="post" id="contactForm" novalidate="novalidate">
                        ...
                        <div class="col-md-12 text-left">
                            <button type="submit" value="submit" name="submit" class="primary_btn" onclick="location.href='mailto:padillajoshuaanderson.pdm@gmail.com'" >
...
<div class="col-lg-9">
            ...
            <div id="mapBox" class="mapBox"
                    ...
                    data-lon="120.973228"
                    data-zoom="13"
                    data-info="Sta. Rosa 2, Marilao, Bulacan, Philippines."
                    data-mlat="14.774100"
                    data-mlon="120.973228">
