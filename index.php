...
<head>
	...
	<title>Joshua Padilla Portfolio</title>
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="banner_content">
							...
							<h1 class="text-uppercase">I am joshua padilla</h1>
							<h5 class="text-uppercase">freelance web and game developer</h5>
							<div class="d-flex align-items-center">
						<!--================		<a class="primary_btn" href="#"><span>Hire Me</span></a> =================-->
								<a class="primary_btn tr-bg" href="ITProjectManagerResume.pdf"><span>View CV</span></a>
							</div>
						</div>
					</div>
					<div class="col-lg-5">
			...
			<div class="offset-lg-1 col-lg-5">
				<div class="main_title text-left">
					<h2>let’s <br>
						...
						myself</h2>
					<p>
						Hello, my name is Joshua Anderson Padilla, and I am a 23-year-old Bachelor of Information Technology. I am passionate about programming and technology, and I enjoy discovering new knowledge about these fields whenever I have free time. My favorite hobbies include playing chess, watching movies, and exploring different programming languages.

						As a skilled programmer, I am proficient in several programming languages ​​such as PHP, Python, JavaScript, C#, C++, C, and Java. My ultimate goal is to become a senior developer and to share my knowledge and expertise with junior developers to help them grow and excel in their careers.
						
						 </p>
					<p>
						I believe that by sharing my knowledge and experiences with others, I can make a significant contribution to the field of programming and help build a community of skilled and knowledgeable developers. With my passion for technology and programming, I am excited to see what the future holds for this industry and am eager to continue learning and growing in my career.   
					</p>
					<a class="primary_btn" href="ITProjectManagerResume.pdf" target="_blank" download><span>Download CV</span></a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
		...
		<div class="row justify-content-center">
			...
			<div class="col-lg-6">
				...
				<center><h1>Client Feedback And Proof Of Transaction</h1></center> 
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="single-brand-item d-table">
							<div class="d-table-cell text-center">
								<img src="img/Payment/t5.jpg" alt="">
							</div>
						</div>
					</div>	
					...
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="single-brand-item d-table">
							<div class="d-table-cell text-center">
								<img src="img/Payment/t4.jpg" alt="">
							</div>
						</div>
					</div>	
					...
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="single-brand-item d-table">
							<div class="d-table-cell text-center">
								<img src="img/Payment/t3.jpg" alt="">
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="single-brand-item d-table">
							<div class="d-table-cell text-center">
								<img src="img/Payment/t2.jpg" alt="">
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="single-brand-item d-table">
							<div class="d-table-cell text-center">
								<img src="img/Payment/t1.jpg" alt="">
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="single-brand-item d-table">
							<div class="d-table-cell text-center">
								<img src="img/Payment/s15.jpg" alt="">
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="single-brand-item d-table">
							<div class="d-table-cell text-center">
								<img src="img/Payment/s14.jpg" alt="">
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="single-brand-item d-table">
							<div class="d-table-cell text-center">
								<img src="img/Payment/s13.jpg" alt="">
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="single-brand-item d-table">
							<div class="d-table-cell text-center">
								<img src="img/Payment/s12.jpg" alt="">
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="single-brand-item d-table">
							<div class="d-table-cell text-center">
								<img src="img/Payment/s11.jpg" alt="">
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="single-brand-item d-table">
							<div class="d-table-cell text-center">
								<img src="img/Payment/s10.jpg" alt="">
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="single-brand-item d-table">
							<div class="d-table-cell text-center">
								<img src="img/Payment/s9.jpg" alt="">
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="single-brand-item d-table">
							<div class="d-table-cell text-center">
								<img src="img/Payment/s8.jpg" alt="">
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="single-brand-item d-table">
							<div class="d-table-cell text-center">
								<img src="img/Payment/s7.jpg" alt="">
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="single-brand-item d-table">
							<div class="d-table-cell text-center">
								<img src="img/Payment/s6.jpg" alt="">
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="single-brand-item d-table">
							<div class="d-table-cell text-center">
								<img src="img/Payment/s5.jpg" alt="">
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="single-brand-item d-table">
							<div class="d-table-cell text-center">
								<img src="img/Payment/s4.jpg" alt="">
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="single-brand-item d-table">
							<div class="d-table-cell text-center">
								<img src="img/Payment/s3.jpg" alt="">
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="single-brand-item d-table">
							<div class="d-table-cell text-center">
								<img src="img/Payment/s2.jpg" alt="">
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="single-brand-item d-table">
							<div class="d-table-cell text-center">
								<img id="pic1" src="img/Payment/s0.jpg" alt="">
			...
			<div class="offset-lg-2 col-lg-4 col-md-6">
				<div class="client-info">
					<div class="d-flex mb-50">
						...
						<span class="smll">Years Experience Working in Freelancing</span>
					</div>
